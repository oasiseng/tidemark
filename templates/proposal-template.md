# Proposal Template — FERE Service
...
**RE: Proposal for Formwork Elevation Reference Exhibit**
**Project: [PROJECT DESCRIPTION]**
**Location: [PROJECT ADDRESS]**

Dear [CLIENT NAME],

Thank you for contacting Oasis Engineering regarding elevation reference services for your proposed [STRUCTURE TYPE] at [PROJECT ADDRESS].

We understand that you need to establish the correct Finished Floor Elevation (FFE) for formwork placement and that the project [is located within FEMA Flood Zone [X] / requires FFE documentation for permit compliance]. We propose the following scope of work to address this need.
